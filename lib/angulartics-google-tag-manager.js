...
(function (angular) {
  ...
  angular.module('angulartics.google.tagmanager', ['angulartics'])
    .config(['$analyticsProvider', function ($analyticsProvider) {
       ...
       * @name exceptionTrack
       *
       * @param {object} properties Comprised of the mandatory field 'description' (string) and optional  fields 'stack' (string)
       */

      $analyticsProvider.registerExceptionTrack(function (properties) {

        if (!properties.description) {
          console.log('Property description is required to be set');
          return;
        }

        eventTrack(properties.description, {
          'category': 'Exceptions',
